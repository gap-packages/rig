...
### Wrappers ###
################
DeclareGlobalFunction("Derive");
DeclareGlobalFunction("OppositeDerive");
DeclareGlobalFunction("IsNonZero");
...
DeclareGlobalFunction("DeriveOpNP");
DeclareGlobalFunction("DeriveMultipleNP");
DeclareGlobalFunction("DeriveOpMultipleNP");
...
DeclareGlobalFunction("NPRecursiveDerivationSequence");
